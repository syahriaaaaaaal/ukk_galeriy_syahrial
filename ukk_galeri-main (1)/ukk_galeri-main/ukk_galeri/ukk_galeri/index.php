...
<html lang="en">
    <head>
        ...
        <style>
            body {
                background-color: #FAD6D8; /* Soft Pink */
            }
            .sb-topnav.navbar {
                background-color: #F4A6A0; /* Soft Pink for Navbar */
            }
            .sb-sidenav {
                background-color: #FAD6D8; /* Soft Pink for Sidebar */
            }
            .sb-sidenav .nav-link {
            ...
            .sb-sidenav .nav-link:hover {
                background-color: #F4A6A0; /* Hover effect for navigation links */
                color: #FFFFFF; /* Text color on hover */
            }
            .sb-sidenav-footer {
                background-color: #F4A6A0; /* Soft Pink for Sidebar Footer */
                color: #FFFFFF; /* White text color for footer */
            }
            footer.py-4.bg-light.mt-auto {
                background-color: #FAD6D8; /* Soft Pink for Footer */
